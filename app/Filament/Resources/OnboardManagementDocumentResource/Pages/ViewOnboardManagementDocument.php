...
class ViewOnboardManagementDocument extends ViewRecord
{
        ...
        return $infolist
            ->schema([
                ...
                Tabs::make('Checklist de Documentos')
                    ->columnSpanFull()
                    ->tabs([
                        Tabs\Tab::make('Parte 1 - Sistema de Gestión de Seguridad')
                            ->icon('heroicon-o-document-text')
                            ->schema([
                                static::createChecklistInfoSection('parte_1_items', 'Sistema de Gestión de Seguridad'),
                            ]),
                        Tabs\Tab::make('Parte 2 - Planes de Contingencia')
                            ->icon('heroicon-o-exclamation-triangle')
                            ->schema([
                                static::createChecklistInfoSection('parte_2_items', 'Planes de Contingencia'),
                            ]),
